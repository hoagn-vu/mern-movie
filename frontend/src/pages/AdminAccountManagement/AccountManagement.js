              ...
              <tr key={account._id}>
                ...
                <td>
                  ...
                  <button
                    ...
                    onClick={() => {
                        handleDelete(account.username, account._id);
                    }}
                  >
              ...
              <div className="modal-body account-manage-input-modal-body">
                <form>
                  <div className="form-floating mb-3">
                    <input type="text" className="form-control custom-focus" name='fullname' id="fullnameInput" placeholder="Họ tên" value={formData.fullname} onChange={handleInputChange} />
                    <label htmlFor="fullnameInput">Họ tên</label>
                  </div>
                  <div className="form-floating mb-3">
                    <input type="text" className="form-control custom-focus" name='email' id="emailInput" placeholder="Email" value={formData.email} onChange={handleInputChange} />
                    <label htmlFor="emailInput">Email</label>
                  </div>
                  <div className="form-floating mb-3">
                    <input type="text" className="form-control custom-focus" name='username' id="usernameInput" placeholder="Tên tài khoản" value={formData.username} onChange={handleInputChange} />

...
const Tpage = () => {
    ...
    return (
        <div className="container container-test">
            ...
            <img src={`https://idev1-bucket.s3.ap-southeast-2.amazonaws.com/movies/Iron-Man-2/banner?timestamp=${new Date().getTime()}`} alt='test image' className="poster-fluid rounded" />

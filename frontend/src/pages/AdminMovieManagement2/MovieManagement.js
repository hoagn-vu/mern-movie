...
import EditMovieForm from '../EditMovieForm2/EditMovieForm';
import Pagination from '../../components/Pagination/Pagination';
import api from '../../api/api';

import ImageWithSkeletonSwiper from '../../components/ImageWithSkeletonSwiper/ImageWithSkeletonSwiper';

const MovieManagement = ({ movies, setMovies, originalMovies, setOriginalMovies, getAllMovies, handleUploadMovie, toggleToastBodyFunc, handleEditMovie }) => {
  ...
  return (
    <div className="container-fluid movie-management-container p-4">
      { !isEditingMovie ? (
        ...
        <EditMovieForm movieDataEdit={movieEdit} callCancelEditMovie={afterEditOrAddMovie} callEditMovie={handleEditMovie} />
      )}
    </div>
  );
};
